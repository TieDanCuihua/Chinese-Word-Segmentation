...
def parse_args():
	...
	parser.add_argument("--original_file_path", default="icwb2-data/training/msr_training.utf8",help="The path of the original file")
	parser.add_argument("--input_file_path",default="input_msr_training", help="The path of the input file with no spaces")
	parser.add_argument("--label_file_path", default="label_msr_training",help="The path of the label file in BIES format")
...
def get_ngrams(input_file_path):
	...
	unigram_input = open('msr_unigram.utf8', 'w', encoding='utf8')
